...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([navBar backgroundImageForBarMetrics:UIBarMetricsDefault] != [BaseViewController defaultNavigationBarImage]) {
        [navBar setBackgroundImage:[BaseViewController defaultNavigationBarImage] forBarMetrics:UIBarMetricsDefault];
    }
    
    if (navBar.shadowImage != [BaseViewController defaultNavigationBarShadowImage]) {
        navBar.shadowImage = [BaseViewController defaultNavigationBarShadowImage];
    }
