...
#import "XYLoanDescriptionCell.h"
#import "UITextView+Placeholder.h"
#import "UIViewController+ShowTextHUD.h"
#import "XYLoanHeaderView.h"
...
- (void)viewDidLoad {
    ...
    self.tableView.tableHeaderView = [[XYLoanHeaderView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 70.0)];
    ...
    [self.tableView registerClass:[XYLoanViewCell class] forCellReuseIdentifier:loanReuseID];
    [self.tableView registerClass:[XYLoanDescriptionCell class] forCellReuseIdentifier:loanDesReuseID];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = nil;
    if (indexPath.section == 0) {
        XYLoanViewCell *cell0 = [tableView dequeueReusableCellWithIdentifier:loanReuseID forIndexPath:indexPath];
        ...
        XYLoanDescriptionCell *cell1 = [tableView dequeueReusableCellWithIdentifier:loanDesReuseID forIndexPath:indexPath];
        XYLoanModel *model = _itemList[indexPath.section][indexPath.row];
...
#pragma mark -
#pragma mark - XYLoanViewCellDelegate
...
- (BOOL)loanViewCell:(XYLoanViewCell *)cell textFieldShouldBeginEditing:(UITextField *)textField {
    ...
    if (model.editable == NO) {
        ...
        XYPickerView *view = [[XYPickerView alloc] initWithPickerDataSource:model.sheetTitles completionBlock:^(NSString * _Nonnull selectedValue) {
