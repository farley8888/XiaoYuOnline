...
@interface XYDiscoveryDetailController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *timeLabel;
@property (nonatomic, strong) NSMutableArray<XYDiscoveryDetailModel *> *infoList;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UIImageView *leftImageView;
@property (nonatomic, strong) UIFont *cellTextFont;
@property (nonatomic, strong) XYDiscoveryModel *discoveryModel;
@end

@implementation XYDiscoveryDetailController

- (instancetype)initWithDiscoveryModel:(XYDiscoveryModel *)discoveryModel {
    self = [super init];
    if (self) {
...
- (void)viewDidLoad {
    ...
    [_tableView registerClass:[XYTextInfoViewCell class] forCellReuseIdentifier:discoveryTextReuseID];
    [_tableView registerClass:[XYImageInfoViewCell class] forCellReuseIdentifier:discoveryImageReuseID];
...
- (void)loadUIContent {
    ...
    [self sendRequest:^(XMRequest * _Nonnull request) {
        ...
        for (NSDictionary *data in responseObject[@"content"]) {
            XYDiscoveryDetailModel *model = [[XYDiscoveryDetailModel alloc] initWithData:data restrictWidth:resW attribute:attDic];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    XYDiscoveryDetailModel *model = _infoList[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    XYDiscoveryDetailModel *model = _infoList[indexPath.row];
    if (model.infoType == XYInfoTypeText) {
        XYTextInfoViewCell *cell = [tableView dequeueReusableCellWithIdentifier:discoveryTextReuseID forIndexPath:indexPath];
        cell.textLabel.attributedText = model.attributeContent;
        
        return cell;
    } else {
        XYImageInfoViewCell *cell = [tableView dequeueReusableCellWithIdentifier:discoveryImageReuseID forIndexPath:indexPath];
