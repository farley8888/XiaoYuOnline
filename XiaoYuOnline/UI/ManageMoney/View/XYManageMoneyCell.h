...
@class XYManageMoneyCell;
@protocol XYManageMoneyCellDelegate<NSObject>
- (void)manageMoneyCell:(XYManageMoneyCell *)cell didPressedBuyButton:(UIButton *)button;
@end

@interface XYCustomProgressView : UIProgressView
@end

@interface XYManageMoneyCell : UITableViewCell
...
@property (nonatomic, weak) id<XYManageMoneyCellDelegate> delegate;
