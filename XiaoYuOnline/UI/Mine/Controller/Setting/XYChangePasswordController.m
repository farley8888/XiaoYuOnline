...
@interface XYChangePasswordController ()
...
@implementation XYChangePasswordController
...
- (NSArray<XYBaseInfoModel *> *)datasource {
    return @[[[XYBaseInfoModel alloc] initWithTitle:nil content:nil description:NSLocalizedString(@"Mine_Setting_AC_LP_Origin", nil)],
             [[XYBaseInfoModel alloc] initWithTitle:nil content:nil description:NSLocalizedString(@"Mine_Setting_AC_LP_New", nil)],
             [[XYBaseInfoModel alloc] initWithTitle:nil content:nil description:NSLocalizedString(@"Mine_Setting_AC_LP_NewAgain", nil)]
             ];
}
...
- (void)textValueDidChanged:(UITextField *)textField {
    ...
    for (NSUInteger i = 0, count = _itemList.count; i < count; i ++) {
        ...
        XYBaseInfoModel *model = _itemList[i];
