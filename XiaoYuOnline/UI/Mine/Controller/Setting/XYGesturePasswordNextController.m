//
//  XYGesturePasswordNextController.m
//  XiaoYuOnline
//
...
@interface XYGesturePasswordNextController ()

@end

@implementation XYGesturePasswordNextController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.title = NSLocalizedString(@"Mine_Setting_AC_GP_Title", nil);
    self.itemList = @[[[XYBaseInfoModel alloc] initWithTitle:NSLocalizedString(@"Mine_Setting_AC_GP_Setting", nil) content:nil description:nil]];
