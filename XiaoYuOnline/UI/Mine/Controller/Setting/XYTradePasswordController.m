...
@interface XYTradePasswordController ()
@end

@implementation XYTradePasswordController
...
- (void)footerOperateButtonAction:(UIButton *)button {
    // 验证后跳转
    //...
    XYTradePasswordNextController *vc = [[XYTradePasswordNextController alloc] initWithVerifyCode:_tradeModel.content];
