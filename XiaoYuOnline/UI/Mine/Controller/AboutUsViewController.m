...
@property (nonatomic, strong) NSArray <AboutUsModel *>* itemList;
@end
...
- (void)viewDidLoad {
    ...
    _itemList = [AboutUsModel aboutUsDatasourceList];
    
    self.title = NSLocalizedString(@"Mine_AboutUs", nil);
    [self.tableView registerClass:[AboutUsTableViewCell class] forCellReuseIdentifier:aboutUsReuseID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AboutUsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:aboutUsReuseID forIndexPath:indexPath];
    AboutUsModel *model = _itemList[indexPath.row];
