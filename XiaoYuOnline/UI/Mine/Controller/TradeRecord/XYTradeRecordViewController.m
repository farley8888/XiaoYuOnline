...
#import "XYTradeDetailViewController.h"
...
@interface XYTradeRecordViewController ()<UITableViewDelegate, UITableViewDataSource, WKSegementSliderViewDelegate>
...
@implementation XYTradeRecordViewController
...
- (void)loadTableData:(UITableView *)table list:(NSMutableArray *)list isRefresh:(BOOL)isRefresh {
    ...
    [self sendSilentRequest:^(XMRequest * _Nonnull request) {
        ...
        for (NSDictionary *data in responseObject[@"list"]) {
            XYTradeRecoderModel *model = [[XYTradeRecoderModel alloc] initWithMyInvestListApi:data];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XYTradeDetailViewController *vc = [[XYTradeDetailViewController alloc] initWithTradeModel:model];
