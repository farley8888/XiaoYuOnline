...
//    vender.title = @"理财计算";
    ...
    UITabBarItem *tabbarItem0 = [self getBarItemWithTitle:@"收支" imageName:@"Tabbar_home_unselected"];
   
    UITabBarItem *tabbarItem1 = [self getBarItemWithTitle:@"理财计算" imageName:@"Tabbar_finance_unselected"];
    nav2.tabBarItem = tabbarItem1;
    
    UITabBarItem *tabbarItem2 = [self getBarItemWithTitle:@"更多咨询" imageName:@"Tabbar_my_unselected"];
     nav1.tabBarItem = tabbarItem2;
    nav3.tabBarItem = tabbarItem0;
